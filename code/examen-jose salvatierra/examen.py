...
class SpaceShip:
    ...
    def draw(self):
        ...
        pygame.draw.rect(display, orange, (self.x + 5, self.y + 6, 10, self.h - 10))
        pygame.draw.rect(display, orange, (self.x + self.w - 15, self.y + 6, 10, self.h - 10))
...
class Alien:
    ...
    def draw(self):
        ...
        pygame.draw.ellipse(display, orange, (self.x + 4, self.y + self.d/3, 7, 7), 2)
